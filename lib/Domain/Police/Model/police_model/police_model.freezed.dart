...
class _$PoliceModelImpl implements _PoliceModel {
  _$PoliceModelImpl(
      {this.id, this.name, this.location, this.phone, this.extra, this.date});
  ...
  @override
  String toString() {
    return 'PoliceModel(id: $id, name: $name, location: $location, phone: $phone, extra: $extra, date: $date)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, name, location, phone, extra, date);
...
abstract class _PoliceModel implements PoliceModel {
  factory _PoliceModel(
      ...
      final String? phone,
      final String? extra,
      final String? date}) = _$PoliceModelImpl;
