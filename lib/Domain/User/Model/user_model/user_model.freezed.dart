...
class _$UserModelImpl implements _UserModel {
  ...
  @override
  String toString() {
    return 'UserModel(id: $id, name: $name, gender: $gender, location: $location, phone: $phone, secondaryPhone: $secondaryPhone, email: $email, password: $password)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, name, gender, location,
      phone, secondaryPhone, email, password);
