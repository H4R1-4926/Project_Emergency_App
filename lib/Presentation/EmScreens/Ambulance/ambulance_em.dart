...
import 'package:emergency_app/Infrastrucure/Ambulance/ambulance_repository.dart';
...
class AmbulanceEm extends StatelessWidget {
  AmbulanceEm({super.key});
          ...
          child: ListView(
            children: [
              const CircleAvatar(
                ...
                child: Image(
                  image: AssetImage(
                    'assets/img/ambulance_vector.jpg',
                  ),
                ),
              ),
              const SizedBox(
  ...
  Future<void> submit() async {
    ...
    final ambuModel =
        AmbulanceModel(name: name, phone: phone, location: loc, extra: extra);
    AmbulanceController().sndAmbulanceDetails(ambuModel);
  }
}
